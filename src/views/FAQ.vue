...
<template>
    <div class="relative z-[1]">
        ...
        <main-container class="relative pt-[202px] pb-[136px]">
            ...
            <div class="w-[1026px] h-[880px] border border-red-600 absolute z-[-1] right-[-224px] top-[761px] rounded-[50%] bg-[#D8DBFF] blur-[500px]"></div>
            <div class="relative z-[3]">
                <h1 class="text-[#1f263d] mb-[25px] text-[55px] font-extrabold leading-[70px] tracking-[0%]">Frequently asked Questions</h1>
                <div class="flex gap-[22px] mb-[49px]">
                    <button-blue
